...
export function KenZeOvedPage() {
  ...
  const facebookUrl = share.facebookMedia
    ? `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(pageUrl)}&picture=${encodeURIComponent(share.facebookMedia)}`
  ...
  return (
    <div className="kig-page">
      ...
      >
        ...
        {/* Block 8 — Share (always last) */}
        <motion.section
          className="kig-share"
          variants={blockVariants}
          aria-labelledby="kig-shareHeading"
        >
          <div className="kig-share-card">
            ...
            <div className="kig-shareActions">
              ...
              <a
                ...
                className="kig-shareBtn kig-shareBtn--whatsapp"
                aria-label="שיתוף בוואטסאפ"
              >
                <svg className="kig-shareIcon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="kig-shareBtn kig-shareBtn--facebook"
              ...
              {/* Instagram — links to profile; story sharing enabled when instagramStoryMedia is set */}
              <a
                href={
                  share.instagramStoryMedia
                    ? `instagram-stories://share?backgroundVideo=${encodeURIComponent(share.instagramStoryMedia)}`
                    : 'https://www.instagram.com/joz_ve_loz/'
                }
                target="_blank"
                rel="noopener noreferrer"
                className="kig-shareBtn kig-shareBtn--instagram"
                aria-label="אינסטגרם"
              >
                <svg className="kig-shareIcon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
              ...
              <button
                type="button"
                className="kig-shareBtn kig-shareBtn--copy"
                onClick={handleCopyLink}
                aria-label={copied ? 'הלינק הועתק' : 'העתקת לינק'}
                aria-live="polite"
              >
                {copied ? (
                  <svg className="kig-shareIcon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
