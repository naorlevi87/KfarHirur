// src/pages/home/SocialIcons.jsx
// Brand SVG icons for social / booking links on the home page.
...
// Ontopo: fork-and-knife reservation icon (Ontopo's official logo is not a public brand asset)
export function IconOntopo({ className = '' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M7 2v13h3v7h2v-7h3V2L7 2zm2 2h4v4h-4V4zM17 2c0 0-1 2-1 5s2 4 2 4v11h2V2h-3z"/>
    </svg>
  );
}
