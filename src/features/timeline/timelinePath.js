...
// ── Original path — DO NOT DELETE ────────────────────────────────────────────
// Git commit 98b6252. Canvas 3000×2200, starts bottom-left, ends top-left.
// SEGMENT_DATES: 12 segs, 2014-10 → 2026-03 (7×11 + 5×12 months).
// PATH_BBOX: { minX: 180, maxX: 2400, minY: 40, maxY: 2100 }
// To restore: copy into PATH_SEGMENTS above and set PATH_BBOX accordingly.
export const PATH_SEGMENTS_ORIGINAL = [
  [ 900, 2080,  1050, 2040,  1250, 1960,  1400, 1900],  //  0: זולה → עתלית
  [1400, 1900,  1600, 1820,  1850, 1780,  2050, 1700],  //  1: עתלית → עין כמונים
  [2050, 1700,  2250, 1620,  2380, 1500,  2340, 1340],  //  2: → מנואלה
  [2340, 1340,  2300, 1180,  2100, 1100,  1900, 1060],  //  3: → placeholder-1
